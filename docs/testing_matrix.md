...
| Interop – live MCP | Public interop builders over HTTP transport, partial-data tolerance, handoff object shape | `python scripts/mcp_interop_smoke.py --endpoint http://127.0.0.1:8000/mcp --json` |
