...
> Historical/internal workflow-planning document. The released `v0.2.6` public MCP server is centered on evidence federation and interop; predictive and orchestrator workflow coverage described here remains experimental and non-canonical for the default public surface.
