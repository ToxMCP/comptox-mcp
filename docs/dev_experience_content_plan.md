...
> Historical planning artifact. The `v0.2.6` release preserves the public server boundary around evidence federation and interop; use this document as background context, not as the current public contract.
