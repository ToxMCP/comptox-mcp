...
def call_search_chemical(query: str, search_type: str = "contains"):
    ...
    try:
        ...
        print(f"  Error: {e}")
        print(f"  Is the EPA CompTox MCP server running? Try './scripts/manual/start_epa_mcp.sh'")
        return False
...
def main():
    ...
    print("\n" + "=" * 60)
    if success:
        print("✓ Test Passed. The 'tools/call' method for 'search_chemical' is working correctly.")
