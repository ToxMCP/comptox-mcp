...
def call_mcp_tool(tool_name: str, arguments: dict):
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            sys.stderr.write(f"Error: HTTP request failed with status code {response.status_code}\n")
...
def main():
    ...
    parser.add_argument("--tool", required=True, help="The name of the tool to call (e.g., 'search_chemical').")
    parser.add_argument("--args", required=True, help="A JSON string with the arguments for the tool.")
