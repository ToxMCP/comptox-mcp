...
class ChemicalListResource(BaseResource):
    ...
    def __init__(self, api_key: str):
        ...
        try:
            ...
            logger.info(
                f"Successfully initialized ctx.ChemicalList with timeout={UPSTREAM_TIMEOUT}s"
            )
    ...
    def execute_tool(self, tool_name: str, parameters: Dict[str, Any]) -> Any:
        ...
        if tool_name == "get_public_list_names":
            ...
            return self.get_full_list(list_name=parameters["list_name"])
        else:
    ...
    def get_full_list(self, list_name: str) -> List[Dict[str, Any]]:
        ...
        result = self._with_retry(
            lambda: self.client.get_full_list(list_name=list_name)
        )
        return self._ensure_list(result)
